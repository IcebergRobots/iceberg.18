...
#define M1_CURR         A11 //  Pin zum messen des Motorstroms von M1
#define M2_CURR         A12 //  Pin zum messen des Motorstroms von M2
#define M3_CURR         A13 //  Pin zum messen des Motorstroms von M3
#define M4_CURR         A14 //  Pin zum messen des Motorstroms von M4
...
#define TX2 18  //  Serielles Senden zum Bluetooth HC-05
#define RX2 19  //  Serielles Empfangen vom Bluetooth HC-05
...
#define BUTTON_B 27  //  Dieser Schalter ist vorerst unbelegt.
#define ROTARY_B 28  //  Rotary Encoder Rotation B
#define BUTTON_A 29  //  Dieser Schalter ist vorerst unbelegt.
...
#define PIN_51 51 //  
#define PIN_52 52 //  
#define abgezweigte Verbindung D53  53  //  Pin ohne feste Funktion. Verbunden mit Platinensteckverbinder. Pin 53 MUSS als Output gesetzt sein, nutzen von Pin 53 könnte zu Problemen mit der Pixy führen (ISP und so)
